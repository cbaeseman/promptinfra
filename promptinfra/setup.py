...
setup(
    name='promptinfra',
    description="natuural language prompt infrastructure management.",
    ...
    entry_points="""
    [console_scripts]
    promptinfra=promptinfra.cli:cli
    """,
    python_requires=">=0.0.1",
    license=None,  # noqa
    author='Clifford Baeseman',
    author_email='cbaeseman@gmail.com',
    # Use the URL to the github repo.
    url= 'https://github.com/cbaeseman/promptinfra',
    download_url=(
        f'https://github.com/cbaeseman/'
        f'promptinfra/archive/{version}.tar.gz'
    ),
    keywords=[
